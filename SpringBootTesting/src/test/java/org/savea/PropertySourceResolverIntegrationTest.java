...
class PropertySourceResolverIntegrationTest {
     ...
     * It asserts that the resolved property value is equal to 'jdbc:h2:mem:testdb'.
     */
    @Test
    void shouldTestResourceFile_overridePropertyValues() {
        ...
        // Assert that the resolved property value is equal to 'jdbc:h2:mem:testdb'
        assertEquals("jdbc:h2:mem:testdb", dbSetUp);
    }
}
